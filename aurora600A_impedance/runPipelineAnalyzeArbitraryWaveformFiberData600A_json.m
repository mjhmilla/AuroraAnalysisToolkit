function success = runPipelineAnalyzeArbitraryWaveformFiberData600A_00_json(...
                    ...
                    if((modelSettings.useManuallySetDelay==1 && indexLambda==1) ...
                        ...
                        switch settings.delayModel
                            ...
                            case 'frequency-domain'
                                ...
                                n = length(expData.x);
                                frequencyHz = [0:(1/(n)): (1-(1/n)) ]' .* (sampleFrequency);
                                frequency=frequencyHz.*(2*pi);
                                lpfInv = ((omega + complex(0,1).*frequency)./omega);
                                yUpd = ifft(lpfInv.*fft(expData.y),'symmetric');
